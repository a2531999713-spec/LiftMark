...
## 2026-07-05 home-profile-account-entry-sprint

- 已完成：底部主导航调整为首页 / 计划 / 记录，原“我的”Tab 隐藏为非主导航路由。
- 已完成：首页右上角头像成为账号入口，头像菜单承接个人资料、小组、计划、同步、备份、偏好、权益、设置反馈、隐私政策、用户协议和关于练刻入口。
- 已完成：首页重组为计划进度卡、今日训练 Hero、当前小组 + 开始训练合并卡和今日重点列表；开始训练区域不再出现管理成员入口。
- 已完成：新增个人资料详细页，按账号资料、小组与同步、偏好与权益、法务与支持分组。
- 已完成：隐私政策和用户协议迁移到法务入口，当前以草案页保留信息结构。
- 已完成：昵称保存逻辑改为同步账号缓存、登录会话和当前账号绑定的本地成员资料。
- 后续：真机确认头像菜单动效、个人资料页长内容滚动和法务正式文本。
