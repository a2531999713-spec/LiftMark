...
- 目标/频率/水平/器械/搜索筛选与稳定排序。
- 8 套真实 seed 的模板、phase、day、plan exercise 和 exercise 引用校验。
- 完整预览批量读取、按周分组、相同周提示、未知动作、时长区间和元数据降级。
- 已有副本复用、明确重复复制、双击锁、激活 group 与活动周期。
- onboarding 详情关闭后草稿与推荐选择不变。
