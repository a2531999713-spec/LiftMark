...
```text
1. 计划周期统计。（2026-07-11 已实现，待 188/176 真机账号验收）
2. 历史记录按计划周期筛选。（2026-07-11 已实现，待真机视觉与账号隔离验收）
3. 训练报告详情页。（2026-07-11 已实现，包含旧记录只读 fallback）
4. 训练提醒设置页。
5. 动作图标 icon_key 映射。
```

前三项的实现边界、测试和剩余验收见 `docs/03-architecture/plan-cycle-report-history-implementation-2026-07.md`。
